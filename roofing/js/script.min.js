...
e(".masthead u[contenteditable]").on("blur",function(e)
{
    var zipcode=jQuery.cookie("UserInfoZip");
    var zip=zipcode.split("=")[1];
    if(jQuery(this).text()!=zip)
    {
        
        var enterZipCode = jQuery(this).text().trim();
        var isValidZipCode = false;
        var regex = new RegExp("^[0-9]{5}$|^[0-9]{5}-[0-9]{4}$");
        var regex_digits= new RegExp("^[0-9\ -]+$");
        var isDigit=true;
        // Check the US ZipCode expression
        if (!regex_digits.test(enterZipCode)) {
            isDigit = false;
            isValidZipCode=false;
        }
        else if (!regex.test(enterZipCode)) {
            isValidZipCode = false;
        }
        else {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        isValidZipCode = true;
                          trackZipCodeChangeEvent("ZIP Code Changed" ,zip ,enterZipCode);
                        location.reload();
                    }   
                    else
                    {
...
/*E15 patch */
e('a.umobile-nav').on("click",function(e){e.preventDefault();t()});
e(".zipcode .custom-input button.zipbutton").on("click",function(e)
{
    e.preventDefault();
    $this=jQuery(this);
    ziptest($this);
...
e('input.ziptext').keydown(function (event) {
            var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
            var objbutton=  $(".zipcode .custom-input button.zipbutton");
            if (event.keyCode == 13) {
               
                $('input.ziptext').focus();
                 return ziptest(objbutton);
            }
           
  });

e('input.ziptext').focusout(function() {
    var objbutton=  $(".zipcode .custom-input button.zipbutton");
     return ziptest(objbutton);
  });

function ziptest(obj)
{
    var zipcode=jQuery.cookie("UserInfoZip");
    var zip = "";
    if(zipcode != null){
    ...
    if(obj.parent().children('input.ziptext').val().trim()!=zip)
    {
        
        var enterZipCode = obj.parent().children('input.ziptext').val().trim();
        var isValidZipCode = false;
        var regex = new RegExp("^[0-9]{5}$|^[0-9]{5}-[0-9]{4}$");
        var regex_digits= new RegExp("^[0-9\ -]+$");
        var isDigit=true;
        ...
        if (!regex_digits.test(enterZipCode)) {
            ...
            jQuery.ajax({
                type: "GET",
                url: "http://www.owenscorning.com/UserControls/RoofingLocatorBox/RoofingZipCodeControl.aspx",
                cache: false,
                data: ({ zipCode: enterZipCode }),
                async: false,
                ...
                success: function (data) {
                    if (data == "True")
                    {
                       if(jQuery('.zipcode-tooltip').length==1)
			{
        ...
        if(!isValidZipCode)
        {
            obj.parent().children('input.ziptext').val(zip);
            if (!isDigit)
            {
                alert("Please enter digits only.");
            }
...
e(".masthead u[contenteditable]").on("click",function(t){e(this).addClass("on");
document.execCommand("selectAll",!1,!0);t.preventDefault();return!1}).on("blur",function(){e(this).removeClass("on")}).on("keydown",function(e){var t=e.which==27,n=e.which==13,r=e.target,i=r.nodeName!="INPUT"&&r.nodeName!="TEXTAREA";if(i)if(t){document.execCommand("undo");r.blur()}else if(n){r.blur();e.preventDefault()}});e("div.persona-overlay-bg, div.persona-overlay .close").on("click",function(t){t.preventDefault();e("div.persona-overlay, div.persona-overlay-bg").hide()});e("a.open-persona-overlay").on("click",function(t){t.preventDefault();e("div.persona-overlay, div.persona-overlay-bg").show()});e(".color-thumbs li a").on("click",function(t){t.preventDefault();var n=e(this),r=n.parent().index(),i=n.parent().parent().attr("data-slider");e(i+" li.active").removeClass("active");var s=n.parent().parent().children(".active").removeClass("active");n.parent().addClass("active");e(i+" li:eq("+r+")").addClass("active")});e(".slide ul.directional-nav li a").on("click",function(t){t.preventDefault();$this=e(this);var n=$this.attr("title"),r=$this.parent().parent().attr("data-slider"),i=e('ul[data-slider="'+r+'"].color-thumbs'),s=e(r+" li.active").index();switch(n){case"next":s+=1;break;case"prev":s-=1}var o=e(r+" li").length;s>=o?s=0:s<0&&(s=o-1);e(r+" li.active").removeClass("active");e(r+" li:eq("+s+")").addClass("active");i.find(" li.active").removeClass("active");i.find(" li:eq("+s+")").addClass("active")});e(".info-table tr:nth-child(odd), .info-accordion tr:nth-child(odd)").addClass("zebra");e(".info-accordion > dl > dd").hide();e(".prev").on("click",function(t){t.preventDefault();var n=e(".testimonial-rotator .active"),r=e(".testimonial-rotator .active").prev();r.length==0&&(r=e("#rotate").children(":last"));n.removeClass("active");r.addClass("active")});e(".next").on("click",function(t){t.preventDefault();var n=e(".testimonial-rotator .active"),r=e(".testimonial-rotator .active").next();r.length==0&&(r=e("#rotate").children(":first"));n.removeClass("active");r.addClass("active")});e(".compare-table tr td:nth-child(odd)").addClass("zebra");e(".compare-accordion h4, .compare-accordion h3").on("click",function(t){t.preventDefault();e(this).toggleClass("active");e(this).next().toggle()});e(".compare-table .swatches td .close a").on("click",function(t){t.preventDefault();var n=e(this).attr("href");e(".compare-table tr td:nth-child("+n+")").html('<div style="min-width: 240px;"></div>')});

/*e("#controller").flexslider({animation:"slide",controlNav:!1,animationLoop:!1,direction:"vertical",slideshow:!1,directionNav:!1,prevText:'<i class="icon-angle-left"></i>',nextText:'<i class="icon-angle-right"></i>',itemWidth:"100%",itemMargin:5,asNavFor:"#rotator"});
e("#rotator").flexslider({animation:"slide",controlNav:!0,directionNav:!1,animationLoop:!0,slideshow:!1,sync:"#controller"});*/
/*e("#controller").flexslider({animation:"slide",controlNav:!1,animationLoop:true,direction:"vertical",slideshow:true,directionNav:!1,prevText:'<i class="icon-angle-left"></i>',nextText:'<i class="icon-angle-right"></i>',itemWidth:"100%",asNavFor:"#rotator"});*/
/*e("#controller").flexslider({animation:"slide",controlNav:!1,animationLoop:true,slideshow:true,itemWidth:"",asNavFor:"#rotator",nextText:"",prevText:""});*/
function getCurrentSlide(selector)
{
    var controllerSlides=e("#"+ selector +" .slides li");
    var selectedSlide=e("#"+ selector +" .slides li.flex-active-slide");
    var SelectedIndex=e(controllerSlides).index(selectedSlide);
    return SelectedIndex;
}
function navigateNext(selector)
{
    var controllerSlides=e("#"+ selector +" .slides li");
    var idx=(getCurrentSlide(selector) +1) % e(controllerSlides).length;
    navigateTo(selector,idx ,e('body').innerWidth()>1024);
    var l=jQuery("#rotator").data("flexslider");
    l.flexAnimate(idx,false,false,false, false);
}
function navigatePrevious(selector)
{
    var controllerSlides=e("#"+ selector +" .slides li");
    var idx=(getCurrentSlide(selector) -1) % e(controllerSlides).length;
    navigateTo(selector,idx,e('body').innerWidth()>1024);
...
function navigateTo(selector, slideNumber, isVerticalAnimation)
{
    slideNumber++;
    var cssAttribute=(isVerticalAnimation?"margin-top":"margin-left");
    
    var controller=e("#"+ selector);
    e("#"+ selector +" .slides li").removeClass("flex-active-slide");
    var viewportTop=0 ;
    var viewportBottom=viewportTop + e(controller).height();
    var viewportLeft=0;
    var viewportRight=e(controller).width();
    var slides=e("#"+ selector +" .slides");
    var slideItems=e("li", slides);
    if((isVerticalAnimation && slideItems.length>5) || (!isVerticalAnimation && slideItems.length>4))
    {
        if(slideNumber<=1)
        {
            if(isVerticalAnimation)
            {
                e(".icon-angle-up").hide();
            }
            else
            {
                e(".icon-angle-left").hide();
            }
        }

        if(slideNumber>1 && slideNumber<slideItems.length)
        {
            if(isVerticalAnimation)
            {
                e(".icon-angle-up").show();
                e(".icon-angle-down").show();
            }
            else
            {
                e(".icon-angle-left").show();
                e(".icon-angle-right").show();
            }
        }
        else if(slideNumber==1)
        {
            if(isVerticalAnimation && slideItems.length>5)
            {
                e(".icon-angle-down").show();
            }
            else if(slideItems.length>4)
            {
                e(".icon-angle-right").show();
            }
        }
        if(slideNumber>=slideItems.length)
        {
            if(isVerticalAnimation)
            {
                e(".icon-angle-down").hide();
            }
            else
            {
                e(".icon-angle-right").hide();
            }
        }
    }
    var slide=e("#"+ selector +" .slides li:nth-child("+ slideNumber +")");
    if(isVerticalAnimation?e(slide).position().top<0:e(slide).position().left<0)
    {
        if(isVerticalAnimation)
        {
            e(slides).animate({'margin-top':0});
        }
        else
        {
            e(slides).animate({'margin-left':0});
        }
    }
    else if(isVerticalAnimation?e(slide).position().top + e(slide).height() > viewportBottom: e(slide).position().left + e(slide).width() > viewportRight)
    {
        if(isVerticalAnimation)
        {
            var top= e(slides).css("margin-top");
            top=top=="auto"?0:parseInt(top);
            e(slides).animate({'margin-top':viewportBottom - (e(slide).position().top +  e(slide).height() +20)+ top});
        }
        else
        {
            var left= e(slides).css("margin-left");
            left=left=="auto"?0:parseInt(left);
            e(slides).animate({'margin-left':viewportRight - (e(slide).position().left +  e(slide).width() +30 )+ left});
        }
    }
    e(slide).addClass("flex-active-slide");
}
e(window).resize(function(){
if(e('body').innerWidth()<=1024 && !e("html").hasClass("ie8"))
    {
        var width= (e("#rotator").width()-100) /4;
        //e("#controller").width(e("#rotator").width()-31).css("overflow","hidden").height(e("#controller .slides li:first").height()+30);
        e("#controller").width(e("#rotator").width()-35).css("overflow","hidden").height(e("#controller .slides li:first").height()+30);
        e("#controller ul li").width(width).css("float","left").css("display","inline");
        e("#controller .slides").width( (e("#controller ul li:first").width() +30) *  e("#controller ul li").length);
        e(".requiremin4").hide();
        e(".requiremin5").hide();
        if(e("#controller .slides li").length > 4)
        {
              e(".icon-angle-right").show();
        }
    }
    else
    {
        ...
        e(controller).height(350).css("overflow","hidden").css("width","100%");
        e(".slides",controller).removeAttr("style");
        e("ul li", controller).width(e(".slider-controls").width());
        e(".requiremin4").hide();
        e(".requiremin5").hide();
        if(e(".slides li", controller).length > 5)
        {
            e(".icon-angle-down").show();
        }
    }
...
e("#rotator").flexslider({animation:"slide",animationLoop: true,slideshow: true, prevText: "",slideshowSpeed: 6000,nextText: "",itemMargin:5,
start:function(slider){
    e(e("#controller .slides li")[0]).addClass("flex-active-slide");
    if(e('body').innerWidth()<=1024 && !e("html").hasClass("ie8"))
    {
        var width= (e("#rotator").width()-150) /4;
        //e("#controller").width(e("#rotator").width()-31).css("overflow","hidden").height(e("#controller .slides li:first").height()+30);
        e("#controller").width(e("#rotator").width()-35).css("overflow","hidden").height(e("#controller .slides li:first").height()+30);
        e("#controller ul li").width(width).css("float","left").css("display","inline");
        e("#controller .slides").width( (e("#controller ul li:first").width() +30) *  e("#controller ul li").length);
    ...
    {
        e("#controller").height(350).css("overflow","hidden");
        e("#controller ul li").width(e(".slider-controls").width());
        e(".requiremin4").hide();
        e(".requiremin5").hide();
        if(e("#controller .slides li").length > 5)
        {
            e(".icon-angle-down").show();
        }
//        else
...
//        }
    ...
    e(".icon-angle-down, .icon-angle-right").on("click",function(){
        navigateNext("controller");
    });
    e(".icon-angle-up, .icon-angle-left").on("click",function(){
        navigatePrevious("controller");
    });
},
...
if(enableSlider)
{
    ...
    var li=e("ul.slides > li:not(.clone)",slider.context);
    var currentItem=e(".flex-active-slide",li);
    for(var i=0;i<li.length; i++)
    {
        if(e(li[i]).hasClass("flex-active-slide") && enableSlider)
        {
            navigateTo("controller", i,e('body').innerWidth()>1024);
        }
    }
    }
}
});
//e("#controller").flexslider({animation:"slide",animationLoop: false,slideshow: false, prevText: "",slideshowSpeed: 0,nextText: "",itemMargin:5,direction: e('body').innerWidth()<800?"horizontal":"vertical",smoothHeight:true});
e(".flexslider").length>0&&e(".flexslider .slides li").on("click",function()
{
    if(enableSlider)
    {
        var items=e("li",e(this).parent());
        var idx=e(items).index(this);
        var l=jQuery("#rotator").data("flexslider");
        //var l=jQuery(".flexslider").data("flexslider");
        l.flexAnimate(idx,false,false,false, false);
        e(items).removeClass("flex-active-slide");
        e(this).addClass("flex-active-slide");
        //enableSlider=false;
        //l.pause();l.pause();
    }
});

e("#rotator .slides li a").on("click",function(){
    if(enableSlider)
    {
        var items=e("li",e(this).parent().parent());
        var idx=e(items).index(e(this).parent());
        //alert(idx);
        //console.log("Inside flexslider click");	
        var l=e("#rotator").data("flexslider");
        enableSlider=false;
        //clearInterval(l.animatedSlides);
        l.flexAnimate(idx-1,true,true);  
        //l.pause();
        //l.pause();
        //e("#rotator").flexslider(null);
       
    }
});
/*e(".flexslider").length>0&&e(".flexslider .slides li").on("click",function(){e(this).parent().find(".flex-active-slide").removeClass("flex-active-slide");e(this).addClass("flex-active-slide")});*/


e("#carousel").flexslider({animation:"slide",controlNav:!1,animationLoop:!1,slideshow:!1,itemWidth:"",itemMargin:5,asNavFor:"#slider",nextText:"",prevText:""});e("#slider").flexslider({animation:"slide",controlNav:!0,animationLoop:!0,slideshow:!1,sync:"#carousel"});/*e(".product-shot a, .finished-look").click(function(t){t.preventDefault();e(this).children("i").toggleClass("icon-plus-sign");e(this).children("i").toggleClass("icon-minus-sign");var n=e(this).attr("data-show-content");if(e(this).closest(".shingle-item").hasClass("on")){n=n.replace(".","");if(e(this).closest(".shingle-item.on").find(".is-active").hasClass(n)){e(this).closest(".shingle-item").removeClass("on");e(this).closest(".shingle-item.on").find(".is-active").removeClass("is-active")}else{e(this).closest(".shingle-item.on").find(".is-active").removeClass("is-active");e(this).closest(".shingle-item").find("."+n).addClass("is-active")}}else{e(this).closest(".shingle-item").addClass("on");e(this).closest(".shingle-item.on").find(".is-active").removeClass("is-active");e(this).closest(".shingle-item").find(n).addClass("is-active")}});e(".shingle-colors .close").click(function(t){t.preventDefault();e(this).closest(".shingle-item").find(".icon-minus-sign").addClass("icon-plus-sign");e(this).closest(".shingle-item").find(".icon-minus-sign").removeClass("icon-minus-sign");e(this).closest(".shingle-item").find(".is-active").removeClass("is-active");e(this).closest(".shingle-item").removeClass("on")});*/e(".sorting-s").on("click",function(t){$this=e(this);$this.toggleClass("active");t.preventDefault();e(".select-pop").slideToggle(200)});e(".shingle-p").fitText("3.1");e(".expand-thumb a").click(function(t){t.preventDefault();e(this).closest(".info-item").toggleClass("on")});e(".roofing-info-map a").click(function(t){t.preventDefault();var n=e(this).attr("data-info-item");e(".roofing-info-map").addClass("on");e(".info-item").removeClass("on");e(".info-item").filter("#"+n).toggleClass("on")});e(".roofing-info-map a").on("mouseover",function(){e("img",this).attr("src",e("img",this).attr("src").replace(".png","_on.png"))}).on("mouseout",function(){e("img",this).attr("src",e("img",this).attr("src").replace("_on.png",".png"))});e(".radius").on("click",function(t){t.preventDefault();var n=e(this);if(!e(this).hasClass("default")){e(".default").removeClass("default");e(this).addClass("default")}});e(".icon.email, .label.email").on("click",function(t){t.preventDefault();var n=e(this).attr("data");e(".the-email").each(function(t){var r=e(this).attr("data");r==n&&e(this).slideToggle(200)})});e(".icon-remove.email, .the-email .btn.submit").on("click",function(t){var n=e(this).attr("data");e(".the-email").each(function(t){var r=e(this).attr("data");if(r==n){e(this).slideToggle(200);t.preventDefault()}})});e(".icon.green, .label.green").on("click",function(t){var n=e(this).attr("data");e(".the-green").each(function(t){var r=e(this).attr("data");if(r==n){e(this).slideToggle(200);t.preventDefault()}})});e(".icon-remove.green, .the-green .btn.submit").on("click",function(t){var n=e(this).attr("data");e(".the-green").each(function(t){var r=e(this).attr("data");if(r==n){e(this).slideToggle(200);t.preventDefault()}})});e(".icon.phone, .label.phone").on("click",function(t){t.preventDefault();$this=e(this);$this.toggleClass("active");$this.siblings().closest(".the-phone").slideToggle(200)});e(".checkbox_group").toggle(function(){e("input",this).attr("checked","checked");e(this).parent().next().find('input[type="checkbox"]').attr("checked","checked")},function(){e("input",this).removeAttr("checked");e(this).parent().next().find('input[type="checkbox"]').removeAttr("checked")});




// 13/06/13 Fix#n/a Serial 2 Begin
	e('.video-overlay .close, .inactive-bg').on('click', function (t) {
var src=e('.videoIframe').attr('src');
e('.videoIframe').attr('src','');
e('.videoIframe').attr('src',src);
		t.preventDefault();
		e('.video-overlay').hide();
		e('.inactive-bg').hide();
	});
e('.output .icon-remove-sign').on('click', function (t) {
var src=e('.videoIframe').attr('src');
e('.videoIframe').attr('src','');
e('.videoIframe').attr('src',src);
		t.preventDefault();
	...
	e('.open-video-overlay').on('click', function (t) {
		t.preventDefault();
		var videoId = e(this).attr('data-video');
		// 02/07/13 Video Popup Fix Serial 2 Begin
	    e('.inactive-bg').show();
	    e('#inactive-bg-' + videoId).show();
	    // 02/07/13 Video Popup Fix Serial 2 End
		e('#video-overlay-' + videoId).show();
	});
	// 13/06/13 Fix#n/a Serial 2 End
e('.open-contractor-overlay').on('click', function(t) {
     t.preventDefault();
     var contractor = e(this).attr('data-contractor');
            
     e(contractor).addClass('active');
     var position = e(this).parent().offset();
            
     var width = $(window).width();
            
     if(width < 767) {
        e(contractor).css('top', position.top - 500);   
     }
     
     e('div.persona-overlay-bg').show();
});
...
e(".flexslider").length > 0 && e(".flexslider .slides li").on("click", function () {
 			e(this).parent().find(".flex-active-slide").removeClass("flex-active-slide"); e(this).addClass("flex-active-slide")
 		});
...
if($("#gSlider").length > 0 && $("#gSlider .slides li").length>1)
{
...
else if ($("#gSlider").length > 0)
{
    $('#gSlider').removeAttr("class");
}
...
var ct = $("#product-carousel ul.slides li").length;

if(ct != null && ct < 5&&($(window).width()>900))
...
var n=e("div.warranty-register"),r=e("div.tmp-wrapper"),i=10,s=Array();s[0]=new u("Homeowner name*","homeowner-name","text","large");s[1]=new u("Phone Number*","phone","tel","large");s[2]=new u("Email address*","id","text","large");s[3]=new u("Address*","address","text","large","",!0);s[4]=new u("Zipcode*","zipcode","text","small","",!0);s[5]=new u("City*","city","text","small");s[6]=new u("State","state","text","small");s[7]=new u("Contractor Name*","contractor-name","text","medium","",!0);s[8]=new u("Contractor Address","contractor-address","text","large");if(e(".warranty-register").length!=0)for(var o=0;o<i;o++)s[o].addField("roofing-form-1");var i=3,s=Array();s[0]=new u("Shingle Name*","shingle-name","text","large");s[1]=new u("Shingle Color","shingle-color","text","large");s[2]=new u("Number of squares purchased","squares-purchased","text","small");if(e(".warranty-register").length!=0)for(var o=0;o<i;o++)s[o].addField("roofing-form-2");e("#carousel").flexslider({animation:"slide",controlNav:!1,animationLoop:!1,slideshow:!1,itemWidth:"",itemMargin:5,asNavFor:"#slider",nextText:"",prevText:""});e("#slider").flexslider({animation:"slide",controlNav:!0,animationLoop:!1,slideshow:!1,sync:"#carousel"});e(".info-table tr:nth-child(odd), .info-accordion tr:nth-child(odd)").addClass("zebra");e(".info-accordion > dl > dd").hide();e(".info-accordion > dl > dt").on("click",function(t){e(".info-accordion > dl > dd").slideUp();e(".info-accordion > dl > dt").removeClass("active");if(e(this).next().is(":hidden")){e(this).toggleClass("active");e(this).next().slideDown()}return!1});e(".tab-box tr:nth-child(even), .tab-box-accordion tr:nth-child(even), .info-table tr:nth-child(odd), .info-accordion tr:nth-child(odd)").addClass("zebra");e(".tab-box").organicTabs({speed:200,navLinks:"a",navLinksCurrent:".nav a"});e(".tab-box-accordion > dl > dd").hide();e(".tab-box-accordion > dl > dt").on("click",function(t){e(".tab-box-accordion > dl > dd").slideUp();e(".tab-box-accordion > dl > dt").removeClass("active");if(e(this).next().is(":hidden")){e(this).toggleClass("active");e(this).next().slideDown()}return!1});e(".info-table tr:nth-child(odd), .info-accordion tr:nth-child(odd)").addClass("zebra");e(".info-table .zebra th").addClass("zebra2");e(".info-table .zebra").each(function(){e("td:lt(2)",this).addClass("zebra2")});e(".info-accordion > dl > dd").hide();e(".sort").on("click",function(t){e(".sort.active").removeClass("active");e(".results.active").removeClass("active");e(this).addClass("active");var n=e(this).attr("data-results");e(".results"+n).addClass("active")});e(".btn.filter").on("click",function(t){e(".button-wrapper-serp").slideToggle(200);t.preventDefault()})});e(document).ready(function(){e("ul.mega-menu-sub-inset li").mouseenter(function(){the_id=e(this).attr("id");e(".mega-menu-sub-default").css("display","none");e("#"+the_id+"-copy").css("display","block")}).mouseleave(function(){e("#"+the_id+"-copy").css("display","none");e(".mega-menu-sub-default").css("display","block")})})})(jQuery);
$(document).ready(function () {
    $('.color-swatches ul li a, .link-all-color-content,.finished-look,.color-swatches ul li').click(function (e) {
        e.preventDefault();
        e.stopPropagation();
        //  $(this).children('i').toggleClass('icon-plus-sign');
        //  $(this).children('i').toggleClass('icon-minus-sign');
        var showContent = $(this).attr('data-show-content');

        var shingleComparisonSection = $(".shingle-comparison");  //E10 change
        var shingleComparisonHeight = shingleComparisonSection.outerHeight(); //E10 change

        if ($(this).closest('.shingle-item').hasClass('on')) {
            showContent = showContent.replace('.', '');
            if ($(this).closest('.shingle-item.on').find('.is-active').hasClass(showContent)) {
                $(this).closest('.shingle-item').removeClass('on');
                $(this).closest('.shingle-item.on').find('.is-active').removeClass('is-active');
                var offset = $(this).parent().parent().offset().top;
                //$("html, body").animate({ 'scrollTop': offset }, "slow"); //E10 change
                $("html, body").animate({ 'scrollTop': offset - shingleComparisonHeight }, "slow");   //E10 change
                $(".shingle-comparison").show();
                ...
                $(this).closest('.shingle-item.on').find('.is-active').removeClass('is-active');
                $(this).closest('.shingle-item').find('.' + showContent).addClass('is-active');
                var offset = $(this).parent().parent().offset().top;
                $("html, body").animate({ 'scrollTop': offset }, "slow");
            }
        }
        else {
            $(this).closest('.shingle-item').addClass('on');
            $(this).closest('.shingle-item.on').find('.is-active').removeClass('is-active');
            $(this).closest('.shingle-item').find(showContent).addClass('is-active');
            if ($(this).attr('data-show-content') == '.finished-look-content') {
                var offset = $(this).closest('.shingle-item').children('.shingle-colors').offset().top;
                $("html, body").animate({ 'scrollTop': offset }, "slow");  //E10 change
                //$("html, body").animate({ 'scrollTop': offset - shingleComparisonHeight }, "slow");  //E10 change
                $(".shingle-comparison").hide();
                if ($('.pop').css('display') == 'none') {
                    $("#filter-section").hide();
                }
                if ($('.pop').css('display') != 'none') {
                ...
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.color-details').children('.colornames').children('li').removeClass('active');
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.color-details').children('.colornames').children('li').eq(activeindex).addClass('active');
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.color-thumbs').children('li').removeClass('active');
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.color-thumbs').children('li').eq(activeindex).addClass('active');
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.slide').children('.shingle-slider').children('li').removeClass('active');
                $(this).closest('.shingle-item').children('.shingle-colors').children('.container').children('.all-colors-content').children('.slide').children('.shingle-slider').children('li').eq(activeindex).addClass('active');
                // $(this).closest('.shingle-item').children('.shingle-slider li').eq().addClass('active');
                var offset = $(this).closest('.shingle-item').children('.shingle-colors').offset().top;
                //$("html, body").animate({ 'scrollTop': offset - shingleComparisonHeight }, "slow");  //E10 change
                $("html, body").animate({ 'scrollTop': offset }, "slow");  //E10 change
                $(".shingle-comparison").hide();
    ...
    $('.shingle-colors .close').click(function (e) {
        e.preventDefault();
        // $(this).closest('.shingle-item').find('.icon-minus-sign').addClass('icon-plus-sign');
        // $(this).closest('.shingle-item').find('.icon-minus-sign').removeClass('icon-minus-sign');
        $(this).closest('.shingle-item').find('.is-active').removeClass('is-active');
        $(this).closest('.shingle-item').removeClass('on');

        var shingleComparisonSection = $(".shingle-comparison");             //E10 change 
        var shingleComparisonHeight = shingleComparisonSection.outerHeight(); //E10 change 
        var offset = $(this).parent().parent().parent().offset().top;
        $("html, body").animate({ 'scrollTop': offset - shingleComparisonHeight }, "slow");  //E10 change
        //$("html, body").animate({ 'scrollTop': offset }, "slow");
        $(".shingle-comparison").show();
        if ($('.pop').css('display') == 'none') {
    ...
    /* E15 patch*/
    $("a.upersona-overlay").on("click", function (t) { t.preventDefault(); $("div.persona-overlay, div.persona-overlay-bg").show() });
    /*E15*/
});
